...
export default function Profile() {
  return (
    <div className="main-box">
      ...
      <div className="lower">
        <h2 className="profile-name">Phil Josh P Tongco</h2>
        ...
        <div className="social-rate">
          <div className="rate-item">
            <img src={heart_icon} alt="heart" /> <span>90k</span>
          </div>
          <p>|</p>
          <div className="rate-item">
            <img src={comment_icon} alt="comment" /> <span>10k</span>
          </div>
          <p>|</p>
          <div className="rate-item">
            <img src={share_icon} alt="share" /> <span>7k</span>
          </div>
        </div>
      </div>
    </div>
